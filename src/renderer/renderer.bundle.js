(() => {
  ...
  var require_search = __commonJS({
    "src/renderer/components/search.js"(exports, module) {
      ...
      var VIDEO_EXTENSIONS = [".mp4", ".mkv", ".avi", ".mov", ".wmv", ".flv", ".webm"];
      var AUDIO_EXTENSIONS = [".mp3", ".wav", ".flac", ".aac", ".ogg", ".wma", ".m4a"];
      var DOC_EXTENSIONS = [".pdf", ".doc", ".docx", ".xls", ".xlsx", ".ppt", ".pptx", ".txt", ".rtf"];
      var CODE_EXTENSIONS = [".js", ".ts", ".jsx", ".tsx", ".py", ".java", ".cpp", ".c", ".h", ".css", ".html", ".json", ".xml", ".yml", ".yaml", ".md", ".sh", ".bat", ".ps1"];
      var ARCHIVE_EXTENSIONS = [".zip", ".rar", ".7z", ".tar", ".gz", ".bz2"];
      var EXEC_EXTENSIONS = [".exe", ".msi", ".app", ".dmg", ".deb", ".rpm", ".cmd", ".bat", ".sh"];
